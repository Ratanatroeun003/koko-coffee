    ...
    <header className="sticky top-0 z-50 w-full border-b border-stone-200/80 bg-gray-200/80 backdrop-blur-md">
      <div className="mx-auto flex w-full max-w-7xl items-center justify-between px-4 py-2.5 sm:px-6">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <Link
            href="/location"
            className="flex items-center gap-1.5 rounded-full border border-stone-200/80 bg-stone-50 p-2 text-xs font-bold text-stone-700 transition-all hover:bg-stone-100 hover:text-stone-950 active:scale-95"
          >
